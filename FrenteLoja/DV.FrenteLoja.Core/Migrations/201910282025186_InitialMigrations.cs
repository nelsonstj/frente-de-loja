    ...
    public partial class InitialMigrations : DbMigration
    {
        public override void Up()
        {
                ...
                c => new
                    {
                        ...
                        Modelo = c.String(),
                        Versao = c.String(),
                        VersaoMotor = c.String(),
                        InicioProducao = c.DateTime(nullable: false),
                        FinalProducao = c.DateTime(nullable: false),
                    })
                .PrimaryKey(t => t.id);
            
            CreateTable(
                "dbo.VW_VEICULO_PRODUTOS",
                c => new
                    {
                        Veiculo_Id = c.String(nullable: false, maxLength: 128),
                        PartNumber = c.String(),
                        GrupoProduto = c.String(),
            ...
            CreateTable(
                ...
                c => new
                    {
                        ...
                        DataAtualizacao = c.DateTime(nullable: false),
                        UsuarioAtualizacao = c.String(),
                        MarcaModeloVersao_Id = c.Long(),
                        Veiculo_Id = c.Long(),
                    })
                .PrimaryKey(t => t.Id)
                .ForeignKey("dbo.MARCA_MODELO_VERSAO", t => t.MarcaModeloVersao_Id)
                ...
                .Index(t => t.MarcaModeloVersao_Id)
                ...
                c => new
                    {
                        ...
                        TipoCondicaoPagamento = c.String(),
                        CondicaoDeVenda = c.Boolean(nullable: false),
                        Descricao = c.String(),
                        RegistroInativo = c.Boolean(nullable: false),
                        CampoCodigo = c.String(maxLength: 12),
                        DataAtualizacao = c.DateTime(nullable: false),
                ...
                c => new
                    {
                        ...
                        TipoCliente = c.String(maxLength: 1),
                ...
                c => new
                    {
                        ...
                        RegistroInativo = c.Boolean(nullable: false),
                        DataAtualizacao = c.DateTime(nullable: false),
                        UsuarioAtualizacao = c.String(maxLength: 100),
                    })
                .PrimaryKey(t => t.Id)
                ...
                c => new
                    {
                        ...
                        Aro = c.Decimal(nullable: false, precision: 18, scale: 2),
                        Largura = c.Decimal(nullable: false, precision: 18, scale: 2),
                        Perfil = c.Decimal(nullable: false, precision: 18, scale: 2),
            ...
            CreateTable(
                ...
                .PrimaryKey(t => t.Id)
                .ForeignKey("dbo.GRUPO_SUB_GRUPO", t => t.IdGrupoSubGrupo)
                .Index(t => t.IdGrupoSubGrupo)
                .Index(t => t.CampoCodigo, unique: true);
                ...
                c => new
                    {
                        ...
                        CodigoDellavia = c.String(),
                        VersaoMotor = c.String(maxLength: 30),
                        Descricao = c.String(),
                        DataAtualizacao = c.DateTime(nullable: false),
                        UsuarioAtualizacao = c.String(),
                    })
        ...
        public override void Down()
        {
            ...
            DropForeignKey("dbo.ORCAMENTO", "Veiculo_Id", "dbo.VEICULO");
            ...
            DropIndex("dbo.ORCAMENTO", new[] { "Veiculo_Id" });
            ...
            DropTable("dbo.VW_VEICULO_PRODUTOS");
            DropTable("dbo.VW_VEICULOS");
        }
    }
}
